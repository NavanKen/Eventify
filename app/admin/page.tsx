...
const AdminPages = () => {
  ...
  const statCards = [
    ...
    {
      label: "Pendapatan",
      value: stats ? `Rp ${stats.revenue.toLocaleString("id-ID")}` : "Rp 0",
      icon: Wallet,
      color: "text-rose-600",
    },
  ];
  ...
  return (
    <div className="space-y-8 pb-8">
      ...
      <div className="flex flex-col gap-4">
        <div>
          ...
          <p className="text-base text-[var(--text-light)] flex items-center gap-2">
            ...
            Ringkasan aktivitas sistem dan transaksi terbaru
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-[var(--radius)] border border-border/50 p-6">
          ...
          {quickActions.map((action) => {
            ...
            return (
              <Button
                ...
                asChild
                variant="outline"
                className="h-auto py-4 flex-col gap-2 hover:bg-[var(--primary)]/5 hover:border-[var(--primary)]/30 hover:text-[var(--primary)] transition-all group"
              >
                <Link href={action.href}>
                  <div className="p-2 bg-gray-50 rounded-lg group-hover:bg-[var(--primary)]/10 transition-colors">
                    <Icon className="w-5 h-5" />
                  </div>
